...
- (void)configMediaCaptureView {
    ...
    focusOnImg.alpha = 0;
    [_previewer addSubview:focusOnImg];
...
- (void)tapScreen:(UITapGestureRecognizer *)gesture {
    ...
    if (point.y > self.previewer.frame.size.height - 150) {
        return;
    }
